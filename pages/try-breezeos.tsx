        ...
        <>
            <div className='h-screen text-center flex flex-auto flex-col justify-center items-center bg-gradient-to-t from-sky-300 to-zinc-100 text-slate-900 dark:from-[#270013] dark:to-zinc-950 dark:text-slate-100'>
                ...
                <div className="flex justify-center items-center max-md:flex-col mb-12 h-56 max-md:h-auto">
                    <div
                        className={twMerge(
                            'cursor-pointer py-8 w-52 h-48 max-[1364px]:w-48 max-[1364px]:h-44 max-md:w-48 max-md:h-40 opacity-20 mx-2 my-2 bg-zinc-100/5 border-2 border-solid border-zinc-900/20 rounded-lg flex flex-col text-slate-900 dark:border-zinc-100/20 dark:text-slate-100 transition-all duration-300',
                    ...
                    >
                        <div className="h-full flex justify-center items-center">
                            <SlScreenDesktop className='text-6xl max-[1364px]:text-5xl max-md:text-4xl text-slate-900/50 dark:text-slate-100/20'/>
                        </div>
                    ...
                    >
                        <div className="h-full flex justify-center items-center">
                            <PiDeviceMobileCamera className='text-6xl max-[1364px]:text-5xl max-md:text-4xl text-slate-900/50 dark:text-slate-100/20'/>
                        </div>
                        <p className='font-semibold max-[1364px]:text-sm'>Mobile &#40;dev&#41;</p>
                    </div>
                </div>
                <Link href={platform === 'desktop' ? 'https://baodaigov.github.io/BreezeOS' : 'https://baodaigov.github.io/BreezeOS-Mobile'} passHref onClick={() => setLoading(true)}>
                    <Button className='rounded-lg transition-none bg-slate-900 hover:bg-slate-800 dark:bg-pink-700 dark:hover:bg-pink-600 px-6 py-4 mr-4 text-slate-100 text-sm font-semibold'>
