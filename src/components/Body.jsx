...
export default function Body(){
    ...
    return (
        <>
            <div className="flex flex-col py-28 px-12 overflow-x-hidden bg-gray-50 dark:bg-[#16181d] text-slate-700 dark:text-gray-100">
                <div className='flex flex-col max-w-4xl mx-auto text-center'>
                    <p className='font-bold text-4xl sm:text-5xl'>Get your things done.</p>
                    ...
                    <div className='mt-16 relative'>
                        ...
                        <div className='absolute w-[80%] top-[2%] left-1/2 -translate-x-1/2 -translate-y-[64,5%]'>
                            <img className='rounded-[5px]' src={sourceImage}/>
                        </div>
                    </div>
                    <div className='mt-14 flex justify-center flex-col sm:flex-row'>
                        ...
                        <a href='https://breezeos.github.io/docs' target='_blank' className='flex justify-between items-center rounded-full px-7 py-3 bg-inherit hover:bg-gray-200 dark:hover:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-100 border-[1px] text-[15px] font-bold w-64 sm:w-auto mx-auto sm:mx-0'>
